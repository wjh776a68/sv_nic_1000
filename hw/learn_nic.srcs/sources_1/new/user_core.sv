...
module user_core # (
    ...
    generate for (genvar i = 0; i < 4; i++) begin
        assign ram_mem_en[i] = 1'b0;
        assign ram_mem_we[i] = 1'b0;
    end
    endgenerate
  ...
  /*   wire [127:0] ram_ctl_dout_r = ram_ctl_dout[0];
    wire [63:0]  ram_ctl_addr_r = ram_ctl_addr[0];
    wire [127:0] ram_ctl_din_r = ram_ctl_din[0];
    wire [15:0]  ram_ctl_we_r = ram_ctl_we[0];
    wire [127:0] ram_mem_dout_r = ram_mem_dout[0];
    wire [63:0]  ram_mem_addr_r = ram_mem_addr[0];
    wire [127:0] ram_mem_din_r = ram_mem_din[0];
    wire [15:0]  ram_mem_we_r = ram_mem_we[0]; */
