...
module irq_proc(
    ...
    (* MARK_DEBUG="true" *) input      [1:0]        irq_no,
    ...
    always @(posedge clk) begin
        ...
        SEND_MSI_INTR: begin
            case (irq_no[1:0])
            2'b00: cfg_interrupt_msi_int  <= 32'h00000001;
            2'b01: cfg_interrupt_msi_int  <= 32'h00000002;
            2'b10: cfg_interrupt_msi_int  <= 32'h00000004;
            2'b11: cfg_interrupt_msi_int  <= 32'h00000008;
            endcase
            ...
            case (irq_no[1:0])
            2'b00: cfg_interrupt_msi_pending_status  <= 32'h00000001;
            2'b01: cfg_interrupt_msi_pending_status  <= 32'h00000002;
            2'b10: cfg_interrupt_msi_pending_status  <= 32'h00000004;
            2'b11: cfg_interrupt_msi_pending_status  <= 32'h00000008;
            endcase
